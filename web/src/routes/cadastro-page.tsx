      ...
      <section className="mx-auto grid w-full max-w-6xl items-center gap-8 rounded-3xl bg-surface/80 p-6 shadow-[0_18px_40px_-14px_rgba(15,23,42,0.16)] backdrop-blur-xl md:p-10 lg:grid-cols-[1.05fr_0.95fr]">
        <div className="space-y-6">
          ...
          <div className="space-y-3">
            <span className="inline-flex items-center gap-2 rounded-full bg-secondary/20 px-4 py-2 text-sm font-semibold text-secondary-foreground">
            ...
            <p className="max-w-lg text-base leading-relaxed text-foreground-subtle">
              Escolha seu perfil e cadastre seus dados para entrar no ecossistema
              comercial do Hub44 com uma experiencia simples e moderna.
            </p>
          </div>
        </div>
        ...
        <Card className="w-full max-w-[29rem] justify-self-center self-center rounded-3xl bg-surface-raised py-0 shadow-[0_12px_32px_-4px_rgba(19,27,46,0.08)] ring-1 ring-foreground/8">
          <CardContent className="p-6 md:p-7">
            <div className="mb-8 flex flex-col items-center text-center">
              ...
              <p className="mt-2 max-w-sm text-sm text-foreground-subtle">
